...
public class PastFragment extends SuperSheetsFragment {
    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setResId(R.layout.fragment_past);
        setTabTitle(MainActivity.PAST);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RealmResults<Note> results = App.REALM.where(Note.class)
                .equalTo("archive", true)
                .equalTo("reminder", false)
                .findAllSorted("date");
