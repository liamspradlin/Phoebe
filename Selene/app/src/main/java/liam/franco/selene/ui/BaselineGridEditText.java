...
public class BaselineGridEditText extends FontEditText {
    private float lineHeightMultiplierHint = 1f;
    private float lineHeightHint = 0f;
    private int topPaddingHint = 0;

    public BaselineGridEditText(Context context) {
        this(context, null);
    }

    public BaselineGridEditText(Context context, AttributeSet attrs) {
        this(context, attrs, android.R.attr.editTextStyle);
    }

    public BaselineGridEditText(Context context, AttributeSet attrs, int defStyleAttr) {
